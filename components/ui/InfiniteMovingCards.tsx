  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-slate-800 p-5 md:p-16 md:w-[60vw] bg-[linear-gradient(90deg,#04071d,#0c0e23)]"
            key={idx}
          >
            <blockquote>
              <div
